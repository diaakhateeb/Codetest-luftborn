...
import * as tingle from "../wwwroot/js/tingle";
import MakeRequest from "./Utilities/MakeRequest";
//import * as $ from "../wwwroot/lib/jquery/dist/jquery";
            ...
            .forEach((element: Element, index: number, array: HTMLElement[]) => {
                element.addEventListener(
                    ...
                    () => {
                        ...
                        const userUrl = "http://localhost/LuftbornWebApi/api/User/GetUserById?id=${userId}";
